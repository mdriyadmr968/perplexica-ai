...
6. Wait a few minutes for the setup to complete. You can access Perplexica at http://20.2.88.25:3000 in your web browser.
...
3. Add a new site search with the following URL: `http://20.2.88.25:3000/?q=%s`. Replace `localhost` with your IP address or domain name, and `3000` with the port number if Perplexica is not hosted locally.
